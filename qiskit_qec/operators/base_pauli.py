...
class BasePauli(BaseOperator, AdjointMixin, MultiplyMixin):
    ...
    @classmethod
    def set_tensor_encoding(
        cls, encoding: str = pauli_rep.DEFAULT_EXTERNAL_TENSOR_ENCODING
    ):
    ...
    @classmethod
    def set_phase_encoding(
        cls, encoding: str = pauli_rep.DEFAULT_EXTERNAL_PHASE_ENCODING
    ):
    ...
    @classmethod
    def set_pauli_encoding(
        cls, encoding: str = pauli_rep.DEFAULT_EXTERNAL_PAULI_ENCODING
    ):
    ...
    @classmethod
    def set_syntax(
        cls, syntax_code: Optional[int] = None, syntax_str: Optional[str] = "Product"
    ):
    ...
    def _multiply(
        self, phase, roundit=True
    ) -> "BasePauli":  # pylint: disable=arguments-renamed
    ...
    def evolve(
        self, other: "BasePauli", qargs: Union[None, List, int] = None, frame: str = "h"
    ):
