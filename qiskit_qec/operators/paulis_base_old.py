...
from qiskit_qec.structures.symplectic_matrix_dense_numpy import SymplecticMatrixDenseNumPy
from qiskit_qec.structures.symplectic_matrix import xxx
...
class PaulisBase(BaseOperator, AdjointMixin, MultiplyMixin):
    ...
    external_pauli_rep_format = external_phase_rep_format \
        + external_symp_rep_format
    ...
    def __init__(self, xz_matrix, phase_exponent=None, stype=DENSENUMPY):
        ...
        try:
            ...
            print("Error: To use a non-default symplectic representation first import the needed module")
            exit
