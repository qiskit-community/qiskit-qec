...
class PauliList(BasePauli, LinearMixin, GroupMixin):
    ...
    def __init__(
        ...
        *,
        ...
        self.paulis = [
            Pauli(self.matrix[i], phase_exp=self._phase_exp[i])
    ...
    def phase(self, phase):
        ...
        phase_exp = pauli_rep.cpx2exp(
            phase, output_encoding=pauli_rep.INTERNAL_PHASE_ENCODING
        )
    ...
    @phase_exp.setter
    def phase_exp(
        self, phase_exp, input_phase_encoding=BasePauli.EXTERNAL_PHASE_ENCODING
    ):
    ...
    def insert(self, ind, value, qubit=False):
        ...
        return PauliList(
            (z, x, phase_exp), input_pauli_encoding=BasePauli.EXTERNAL_PAULI_ENCODING
        )
