...
def runme():
    ...
    def annotatePick(picker, curtextActor, curtextMapper):
        print("pick")
    ...
    picker.AddObserver("EndPickEvent", lambda obj, event, p=picker, ta=textActor, tm=textMapper: annotatePick(p, ta, tm))
    ren = vtk.vtkRenderer()
