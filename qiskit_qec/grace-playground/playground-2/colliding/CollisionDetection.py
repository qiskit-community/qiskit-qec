...
def main():
    ...
    # if contactMode == 0:
    #     print(f"contact mode: {contactMode} now using: AllContacts")
    collide.SetCollisionModeToAllContacts()
    # elif contactMode == 1:
    #     print(f"contact mode: {contactMode} now using: SetCollisionModeToFirstContact")
    #
    #     collide.SetCollisionModeToFirstContact()
    # else:
    #     print(f"contact mode: {contactMode} now using: SetCollisionModeToHalfContacts")
    #
