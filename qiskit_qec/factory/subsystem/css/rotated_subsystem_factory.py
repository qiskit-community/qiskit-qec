...
#                         tip = -1
#                     x_gauges.append(
#                         [self.to_index(2 * i, 2 * j, d), tip, self.to_index(2 * i, 2 * j + 2, d),]
#                     )
...
#                         tip = -1
#                     x_gauges.append(
#                         [self.to_index(2 * i, 2 * j, d), self.to_index(2 * i, 2 * j + 2, d), tip,]
#                     )
...
#                         tip = -1
#                     z_gauges.append(
#                         [self.to_index(2 * i, 2 * j, d), self.to_index(2 * i + 2, 2 * j, d), tip,]
#                     )
...
#                         tip = -1
#                     z_gauges.append(
#                         [self.to_index(2 * i, 2 * j, d), tip, self.to_index(2 * i + 2, 2 * j, d),]
#                     )
