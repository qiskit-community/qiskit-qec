...
class RotatedSurfaceCodeBuilder(Builder):
    ...
    def __init__(self,
                 ...
                 *,
                 ...
                 ul_op:Optional[Pauli]=Pauli('Z'))->None:
        ...
        def exclude(vertex_paths:List[List[Vertex]], qubit_data:QubitData)->bool:
            ...
            if weight !=2:
                ...
                if abs(v0_pos[0]-v1_pos[0]) < 0.01: # vertical line
                    ...
                    if abs(v0_pos[1]-self.cutter_ex.bounds.min[1]) < 0.01 \
    ...
    def build(self)->StabSubSystemCode:
        ...
        rotated_surface_code_factory.set_parameters(manifold=Plane(),
                                tile=CheckerBoardTile,
                                tile_optype=self.optype,
                                lattice = Lattice(u_vec=CheckerBoardTile.u_vec,
                                                  v_vec=CheckerBoardTile.v_vec),
                                cutter=self.cutter,
