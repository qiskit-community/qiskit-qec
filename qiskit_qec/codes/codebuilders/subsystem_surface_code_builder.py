...
class SubsystemSurfaceCodeBuilder(Builder):
    """Subsystem Surface Code Builder Class"""
    ...
    def __init__(
        ...
        *,
        ...
        """Initializes a Subsystem Surface Code builder
    ...
    def build(self) -> StabSubSystemCode:
        ...
        ss_code_factory = TileCodeFactory()

        # Configure the code factory
        ss_code_factory.set_parameters(
            manifold=Plane(),
            tile=SquareDiamondTile,
            tile_optype=self.optype,
            lattice=Lattice(
                u_vec=SquareDiamondTile.u_vec, v_vec=SquareDiamondTile.v_vec
            ),
            cutter=self.cutter,
            on_boundary=False,
        ...
        ss_code_factory.update_is_configure()

        # Create the base triangular color code
        return ss_code_factory.make_code()
