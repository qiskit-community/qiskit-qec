...
class GaugeGroup(Group):
    def __init__(
        ...
        Args:
            generators ([type], optional): [description]. Defaults to None.
            gauge_group ([type], optional): [description]. Defaults to None.
            code_id ([type], optional): [description]. Defaults to None.
            code_family ([type], optional): [description]. Defaults to None.
            code_parameters ([type], optional): [description]. Defaults to None.
            deep_copy (bool, optional): [description]. Defaults to False.
