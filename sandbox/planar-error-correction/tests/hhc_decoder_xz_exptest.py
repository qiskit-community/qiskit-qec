...
class TestHHCDecoder(unittest.TestCase):
    ...
    def test_d3_1(self):  # 3 z x pymatching
    ...
    def test_d3_2(self):  # 3 xz z pymatching
        c = HHC(3)
        config = Config()
        config["circuit"]["schedule"] = "heavy-hex"
        config["circuit"]["rounds"] = 3
        config["circuit"]["round_schedule"] = "xz"
    ...
    def test_d3_3(self):  # 3 xz z networkx
        c = HHC(3)
        config = Config()
        config["circuit"]["schedule"] = "heavy-hex"
        config["circuit"]["rounds"] = 3
    ...
    def test_d3_4(self):  # 3 xz z pymatching logical=xx
        c = HHC(3)
        config = Config()
        config["circuit"]["schedule"] = "heavy-hex"
        config["circuit"]["rounds"] = 3
    ...
    def test_d3_5(self):  # 1 xzxzxz z pymatching logical=zxyzxy
        c = HHC(3)
        config = Config()
        config["circuit"]["schedule"] = "heavy-hex"
        config["circuit"]["rounds"] = 1
        config["circuit"]["round_schedule"] = "xzxzxz"
        config["circuit"]["basis"] = "z"
        config["decoder"]["method"] = "matching_pymatching"
        config["circuit"]["logical_paulis"] = "zxyzxy"
        config["circuit"]["distinct_measurement_idle"] = True
        config["circuit"]["barriers"] = False
        config["circuit"]["idles"] = True
        config["circuit"]["num_initialize"] = 1
    ...
    def test_d3_6(self):  # 3 xz z pymatching ted's schedule
        c = HHC(3)
        config = Config()
    ...
    def test_d3_7(self):  # 3 xz z pymatching -1 eigenstate
        c = HHC(3)
        config = Config()
        config["circuit"]["schedule"] = "heavy-hex"
        config["circuit"]["rounds"] = 3
    ...
    def test_d3_8(self):  # 3 xz z pymatching uniform
        c = HHC(3)
        config = Config()
        config["circuit"]["schedule"] = "heavy-hex"
        config["circuit"]["rounds"] = 3
    ...
    def test_d3_9(self):  # 3 xz z networkx uniform
        c = HHC(3)
        config = Config()
        config["circuit"]["schedule"] = "heavy-hex"
        config["circuit"]["rounds"] = 3
    ...
    def test_d3_10(self):  # 3 xz x pymatching
    ...
    def test_d3_11(self):  # 3 xz x networkx
        c = HHC(3)
        config = Config()
        config["circuit"]["schedule"] = "heavy-hex"
        config["circuit"]["rounds"] = 3
    ...
    def test_d3_12(self):  # 3 xz x pymatching -1 eigenstate
        c = HHC(3)
        config = Config()
        config["circuit"]["schedule"] = "heavy-hex"
        config["circuit"]["rounds"] = 3
    ...
    def test_d5_1(self):  # 5 xz z pymatching
        c = HHC(5)
        config = Config()
        config["circuit"]["schedule"] = "heavy-hex"
    ...
    def test_d5_2(self):  # 5 xz x pymatching
        c = HHC(5)
        config = Config()
        config["circuit"]["schedule"] = "heavy-hex"
        config["circuit"]["rounds"] = 5
