...
class TestHHCDecoder(unittest.TestCase):
    ...
    def test_d3_2(self):
        ...
        dec = HHCDecoder(
            n=c.n,
            x_gauge_ops=c.x_gauges,
            x_stabilizer_ops=c.x_stabilizers,
            x_boundary=c.x_boundary,
            z_gauge_ops=c.z_gauges,
            z_stabilizer_ops=c.z_stabilizers,
            z_boundary=c.z_boundary,
            circuit=circ,
            model=self.model,
            basis=basis,
            round_schedule=round_schedule,
